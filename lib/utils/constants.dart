...
class ConstantTexts {
  ...
  final vehicleBaseUrl = 'https://starwars-visualguide.com/assets/img/vehicles/';
  final speciesBaseUrl = 'https://starwars-visualguide.com/assets/img/species/';
  final planetsBaseUrl = 'https://starwars-visualguide.com/assets/img/planets/';
